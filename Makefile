...
help:
	...
	@echo "  make benchmark SERVICE=spring-auto     Run benchmark for a single service"
	@echo "  make benchmark RATE=100                Requests/sec during steady-state (default: 400)"
	@echo "  make benchmark WARMUP_DURATION=60s     Warmup duration (default: 120s)"
	@echo "  make benchmark STEADY_STATE_DURATION=60s  Steady-state duration (default: 800s)"
